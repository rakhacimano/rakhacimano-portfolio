    ...
    useEffect(() => {
        const loadData = async () => {
            try {
                ...
                const data = await fetchAPI(`/projects/id/${resolvedParams.id}`);
    ...
    return (
        <form onSubmit={handleSubmit} className="min-h-screen pb-20">
            ...
            <div className="flex items-center gap-2 text-sm text-[#4c739a] mb-6">
                ...
                <span className="font-medium text-[#0d141b]">Edit Project</span>
            </div>

            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                <div>
                    <h1 className="text-3xl font-black text-[#0d141b] tracking-tight">Edit Portfolio Project</h1>
                    <p className="text-[#4c739a] mt-1">Update your project details.</p>
                </div>
