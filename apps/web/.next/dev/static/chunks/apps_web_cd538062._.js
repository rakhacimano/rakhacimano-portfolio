...
function EditBlog({ params }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditBlog.useEffect": ()=>{
            const loadData = {
                "EditBlog.useEffect.loadData": async ()=>{
                    try {
                        const resolvedParams = await params;
                        setId(resolvedParams.id);
                        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchAPI"])(`/blogs/id/${resolvedParams.id}`);
                        setTitle(data.title);
                        setSlug(data.slug);
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to load blog data");
                        router.push('/admin/blogs');
                    } finally{
                        setFetching(false);
                    }
                }
            }["EditBlog.useEffect.loadData"];
            loadData();
        }
    }["EditBlog.useEffect"], [
        params,
...
_s(EditBlog, "P4x77hYfQEELvbIpI+4uBtFJers=", false, function() {
    return [
...
//# sourceMappingURL=apps_web_cd538062._.js.map