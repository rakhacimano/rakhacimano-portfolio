...
function CreateBlog() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Blog created successfully!');
            setTimeout(()=>router.push('/admin/blogs'), 1500);
        } catch (error) {
            console.error('Failed to create blog', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Failed to create blog');
        } finally{
            setLoading(false);
        }
    };
...
_s(CreateBlog, "UHIsDWYdKS+bq7ov3sgOpckgZM4=", false, function() {
    return [
...
//# sourceMappingURL=_e0558b8d._.js.map