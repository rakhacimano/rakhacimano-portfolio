    ...
    const handleUpload = async (e)=>{
        ...
        try {
            for(let i = 0; i < files.length; i++){
                ...
                const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:4000/api'}/upload?bucket=${bucket}`, {
                    method: 'POST',
                    body: formData
                });
...
function CreateBlog() {
    ...
    const { data: session } = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authClient"].useSession();
    // Form States
...
//# sourceMappingURL=_73ecb141._.js.map