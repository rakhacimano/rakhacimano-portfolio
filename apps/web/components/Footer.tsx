        ...
        <footer id="contact" className="bg-dark text-white pt-24 pb-12 px-6 md:px-10 border-t border-white/10">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex justify-center flex-wrap gap-6 md:gap-12 mb-12">
                    ...
                    <Link href="/portfolio" className="text-sm font-bold uppercase tracking-widest hover:text-primary transition-colors">
                        Portfolio
                    </Link>
                    <Link href="/blog" className="text-sm font-bold uppercase tracking-widest hover:text-primary transition-colors">
                        Blog
                    </Link>
                    <Link
                ...
                <div className="flex flex-col md:flex-row justify-between items-end border-t border-white/10 pt-12">
                    <div className="mb-8 md:mb-0">
                        ...
                        <p className="font-mono text-sm opacity-50">
                            &copy; {currentYear}. UI/UX Designer.<br />
                            Indonesia | {(() => {
