...
import { Instagram, Dribbble, Sms } from "iconsax-react";
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[200px]">
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            <Instagram size="48" variant="Bold" className="mb-4" color="white" />
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            <Dribbble size="42" variant="Bold" color="white" className="mb-4" />
                    ...
                    >
                        ...
                        <Sms size="32" variant="Bold" className="mb-3 text-primary" color="white" />
                    ...
                    >
                        ...
                        <Sms size="32" variant="Bold" className="mb-3" color="white" />
